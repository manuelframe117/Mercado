...
<form action="/Usuarios/{{$usuarios->id}}" method="POST">
    ...
    @method('PUT')
      ...
      <input id ="imagen" type="file" class="form-control formulario" name="imagen" value="{{$usuarios->imagen}}">  
      ...
      <input id="password" type=password" class="form-control formulario" name="password" value="{{$usuarios->password}}">
      
      <label for="password2" class="tituloSeccion">Repita el password</label>
      <input id="password2" type="text" class="form-control formulario" name="password2" value="{{$usuarios->password}}">
